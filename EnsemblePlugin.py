from sparcc import SparCC, MakeBootstraps, PseudoPvals, EmpiricalBrownsMethod
import sys
import numpy

import random
random.seed(1234) # Just for testing
class EnsemblePlugin:
   def input(self, filename):
      # Compute SparCC, Pearson and Spearman correlations on the input file
      #self.dirs = ["sparcc"]
   ...
   def run(self):
      ...
      for dir in self.dirs:
         ...
         #q_star = 0.05   # Same as Weiss
         #q_star = 0.001   # Same as Colquhoun
         ...
         for i in range(1, m+1):
            ...
            if (merged_p_values[i-1][0] > cutoff_P):
               ...
               for j in range(i+1, m+1):
                  ...
                  #print "SETTING ENTRY ", x, ", ", y, " TO ZERO"
                  self.ADJ[x][y] = 0
                  self.ADJ[y][x] = 0
               break
